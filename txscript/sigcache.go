...
func (s *SigCache) Exists(sigHash chainhash.Hash, sig *navec.Signature, pubKey *navec.PublicKey) bool {
	s.RLock()
...
func (s *SigCache) Add(sigHash chainhash.Hash, sig *navec.Signature, pubKey *navec.PublicKey) {
	s.Lock()
	defer s.Unlock()
