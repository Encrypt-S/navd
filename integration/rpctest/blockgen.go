...
func createCoinbaseTx(coinbaseScript []byte, nextBlockHeight int32,
	addr navutil.Address, mineTo []wire.TxOut,
	net *chaincfg.Params) (*navutil.Tx, error) {
...
func CreateBlock(prevBlock *navutil.Block, inclusionTxs []*navutil.Tx,
	blockVersion int32, blockTime time.Time, miningAddr navutil.Address,
	mineTo []wire.TxOut, net *chaincfg.Params) (*navutil.Block, error) {
	...
	blockTxns := []*navutil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := navutil.NewBlock(&block)
