...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.NavCoinNet) ([]*navutil.Block, error) {
	...
	blocks := make([]*navutil.Block, 0, 256)
	genesis := navutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
