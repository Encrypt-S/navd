...
type Tx interface {
	...
	StoreBlock(block *navutil.Block) error
	...
	// block region.
	//
	// For example, it is possible to directly extract Navcoin transactions
...
// DB provides a generic interface that is used to store navcoin blocks and
