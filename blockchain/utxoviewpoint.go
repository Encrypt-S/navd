...
func (view *UtxoViewpoint) AddTxOuts(tx *navutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *navutil.Tx, blockHeight int32, stxos *[]spentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *navutil.Block, stxos *[]spentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(block *navutil.Block, stxos []spentTxOut) error {
...
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *navutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *navutil.Tx) (*UtxoViewpoint, error) {
	b.chainLock.RLock()
