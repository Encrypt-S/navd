...
The navcoin block handling and chain selection rules are an integral, and quite
likely the most important, part of navcoin.  Unfortunately, at the time of
this writing, these rules are also largely undocumented and had to be
ascertained from the navcoind source code.  At its core, navcoin is a
...
Since this package does not deal with other navcoin specifics such as network
