...
func storeFilter(dbTx database.Tx, block *navutil.Block, f *gcs.Filter,
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *navutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *navutil.Block,
	view *blockchain.UtxoViewpoint) error {
