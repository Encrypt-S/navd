...
// children nodes.  A diagram depicting how this works for navcoin transactions
...
// is the zeroHash.
func BuildMerkleTreeStore(transactions []*navutil.Tx, witness bool) []*chainhash.Hash {
...
func ExtractWitnessCommitment(tx *navutil.Tx) ([]byte, bool) {
...
func ValidateWitnessCommitment(blk *navutil.Block) error {
