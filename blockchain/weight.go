...
func GetBlockWeight(blk *navutil.Block) int64 {
...
func GetTransactionWeight(tx *navutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *navutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint,
