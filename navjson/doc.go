...
/*
Package navjson provides primitives for working with the navcoin JSON-RPC API.
...
Unfortunately, the original Navcoin JSON-RPC API (and hence anything compatible
...
*navjson.Error and accessing the ErrorCode field.
