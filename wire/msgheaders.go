...
// a single navcoin headers message.
const MaxBlockHeadersPerMsg = 2000

// MsgHeaders implements the Message interface and represents a navcoin headers
...
func (msg *MsgHeaders) MaxPayloadLength(pver uint32) uint32 {
	...
	return MaxVarIntPayload + ((MaxBlockHeaderPayload + 2) *
		MaxBlockHeadersPerMsg)
}

// NewMsgHeaders returns a new navcoin headers message that conforms to the
