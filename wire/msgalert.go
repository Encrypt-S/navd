...
// MsgAlert  implements the Message interface and defines a navcoin alert
// message.
//
// This is a signed message that provides notifications that the client should
// display if the signature matches the key.  navcoind/navcoin-qt only checks
...
// NewMsgAlert returns a new navcoin alert message that conforms to the Message
