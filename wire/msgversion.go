...
const DefaultUserAgent = "/navwire:4.0.0/"

// MsgVersion implements the Message interface and represents a navcoin version
...
// NewMsgVersion returns a new navcoin version message that conforms to the
