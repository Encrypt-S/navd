...
// MsgReject implements the Message interface and represents a navcoin reject
// message.
//
...
func (msg *MsgReject) MaxPayloadLength(pver uint32) uint32 {
	...
	// RejectVersion.
	if pver >= RejectVersion {
		// Unfortunately the navcoin protocol does not enforce a sane
...
// NewMsgReject returns a new navcoin reject message that conforms to the
