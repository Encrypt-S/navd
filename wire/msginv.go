...
// MsgInv implements the Message interface and represents a navcoin inv message.
...
// NewMsgInv returns a new navcoin inv message that conforms to the Message
...
// NewMsgInvSizeHint returns a new navcoin inv message that conforms to the
