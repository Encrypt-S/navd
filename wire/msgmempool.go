...
// MsgMemPool implements the Message interface and represents a navcoin mempool
...
// NewMsgMemPool returns a new navcoin pong message that conforms to the Message
