...
// MsgBlock implements the Message interface and represents a navcoin
...
// BtcDecode decodes from the navcoin wire protocol as it was sent across the
...
// the navcoin wire protocol in order to be sent across the network.  The wire
...
// NewMsgBlock returns a new navcoin block message that conforms to the
