...
// MsgFilterClear implements the Message interface and represents a navcoin
...
// NewMsgFilterClear returns a new navcoin filterclear message that conforms to the Message
