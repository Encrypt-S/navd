...
// maxNetAddressPayload returns the max payload size for a navcoin NetAddress
...
type NetAddress struct {
	...
	// not present in the navcoin version message (MsgVersion) nor was it
...
func readNetAddress(r io.Reader, pver uint32, na *NetAddress, ts bool) error {
	...
	// NOTE: The navcoin protocol uses a uint32 for the timestamp so it will
	...
	// Sigh.  NavCoin protocol mixes little and big endian.
