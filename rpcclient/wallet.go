...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []navutil.Address) FutureListUnspentResult {
...
func (c *Client) SetTxFeeAsync(fee navutil.Amount) FutureSetTxFeeResult {
	cmd := btcjson.NewSetTxFeeCmd(fee.ToNAV())
	return c.sendCmd(cmd)
}
...
func (c *Client) SetTxFee(fee navutil.Amount) error {
...
func (c *Client) SendToAddressAsync(address navutil.Address, amount navutil.Amount) FutureSendToAddressResult {
	...
	cmd := btcjson.NewSendToAddressCmd(addr, amount.ToNAV(), nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SendToAddress(address navutil.Address, amount navutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentAsync(address navutil.Address,
	amount navutil.Amount, comment,
	commentTo string) FutureSendToAddressResult {

	addr := address.EncodeAddress()
	cmd := btcjson.NewSendToAddressCmd(addr, amount.ToNAV(), &comment,
		&commentTo)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressComment(address navutil.Address, amount navutil.Amount, comment, commentTo string) (*chainhash.Hash, error) {
...
func (c *Client) SendFromAsync(fromAccount string, toAddress navutil.Address, amount navutil.Amount) FutureSendFromResult {
	...
	cmd := btcjson.NewSendFromCmd(fromAccount, addr, amount.ToNAV(), nil,
		nil, nil)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress navutil.Address, amount navutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress navutil.Address, amount navutil.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
	cmd := btcjson.NewSendFromCmd(fromAccount, addr, amount.ToNAV(),
		&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress navutil.Address, amount navutil.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress navutil.Address, amount navutil.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress navutil.Address,
	amount navutil.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[navutil.Address]navutil.Amount) FutureSendManyResult {
	convertedAmounts := make(map[string]float64, len(amounts))
	for addr, amount := range amounts {
		convertedAmounts[addr.EncodeAddress()] = amount.ToNAV()
	}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[navutil.Address]navutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[navutil.Address]navutil.Amount,
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[navutil.Address]navutil.Amount, minConfirms int,
...
func (r FutureAddMultisigAddressResult) Receive() (navutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return navutil.DecodeAddress(addr, &chaincfg.MainNetParams)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []navutil.Address, account string) FutureAddMultisigAddressResult {
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []navutil.Address, account string) (navutil.Address, error) {
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []navutil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}
...
// address.
func (r FutureGetNewAddressResult) Receive() (navutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetNewAddress(account string) (navutil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (navutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddress(account string) (navutil.Address, error) {
...
func (c *Client) GetAccount(address navutil.Address) (string, error) {
...
func (c *Client) SetAccount(address navutil.Address, account string) error {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]navutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	addrs := make([]navutil.Address, 0, len(addrStrings))
	for _, addrStr := range addrStrings {
		addr, err := navutil.DecodeAddress(addrStr,
...
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]navutil.Address, error) {
...
func (c *Client) MoveAsync(fromAccount, toAccount string, amount navutil.Amount) FutureMoveResult {
	cmd := btcjson.NewMoveCmd(fromAccount, toAccount, amount.ToNAV(), nil,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) Move(fromAccount, toAccount string, amount navutil.Amount) (bool, error) {
...
func (c *Client) MoveMinConfAsync(fromAccount, toAccount string,
	...
	cmd := btcjson.NewMoveCmd(fromAccount, toAccount, amount.ToNAV(),
		&minConfirms, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) MoveMinConf(fromAccount, toAccount string, amount navutil.Amount, minConf int) (bool, error) {
...
func (c *Client) MoveComment(fromAccount, toAccount string, amount navutil.Amount,
...
func (r FutureListAccountsResult) Receive() (map[string]navutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]navutil.Amount)
	for k, v := range accounts {
		amount, err := navutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccounts() (map[string]navutil.Amount, error) {
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]navutil.Amount, error) {
...
func (r FutureGetBalanceResult) Receive() (navutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := navutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
// Receive waits for the response promised by the future and returns the
// available balance from the server for the specified account.
func (r FutureGetBalanceParseResult) Receive() (navutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetBalance(account string) (navutil.Amount, error) {
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (navutil.Amount, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (navutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (navutil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (navutil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (navutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalance(account string) (navutil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (navutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
// confirmations.
func (c *Client) GetReceivedByAddress(address navutil.Address) (navutil.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConf(address navutil.Address, minConfirms int) (navutil.Amount, error) {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address navutil.Address, message string) (string, error) {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address navutil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*navutil.WIF, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return navutil.DecodeWIF(privKeyWIF)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address navutil.Address) (*navutil.WIF, error) {
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *navutil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
...
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *navutil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *navutil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *navutil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *navutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *navutil.WIF, label string, rescan bool) error {
...
// NOTE: While getinfo is implemented here (in wallet.go), a navd chain server
...
// DUMP
// importwallet (NYI in navwallet)
// dumpwallet (NYI in navwallet)
