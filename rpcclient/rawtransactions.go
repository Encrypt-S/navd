...
func (r FutureGetRawTransactionResult) Receive() (*navutil.Tx, error) {
	...
	return navutil.NewTx(&msgTx), nil
}
...
// transaction.
func (c *Client) GetRawTransaction(txHash *chainhash.Hash) (*navutil.Tx, error) {
...
func (c *Client) CreateRawTransactionAsync(inputs []btcjson.TransactionInput,
	...
	for addr, amount := range amounts {
		convertedAmts[addr.String()] = amount.ToNAV()
	}
...
func (c *Client) SearchRawTransactions(address navutil.Address, skip, count int, reverse bool, filterAddrs []string) ([]*wire.MsgTx, error) {
...
func (c *Client) SearchRawTransactionsVerboseAsync(address navutil.Address, skip,
