...
(http://godoc.org/github.com/navcoin/navd/peer)
...
```bash
$ go get -u github.com/navcoin/navd/peer
```

## Examples

* [New Outbound Peer Example]
  (https://godoc.org/github.com/navcoin/navd/peer#example-package--NewOutboundPeer)  
